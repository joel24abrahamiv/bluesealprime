    ...
    async execute(message, args, commandName) {
        ...
        try {
            ...
            try {
                ...
                const SA_ROLES = ["bluesealprime", "antinuke", "anti-raid", "quarantine", "botrole"];
                const isProtectedName = SA_ROLES.some(n => roleName.toLowerCase().includes(n));
                ...
                if (isProtectedName) {
                    return message.reply({
                        ...
                        components: [V2.container([
                            ...
                            V2.text("You cannot create roles with reserved Sovereign names.")
                        ], V2_RED)]
                    }).catch(() => { });
                }
