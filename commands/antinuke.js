            ...
            try {
                ...
                if (sub === "limit" || sub === "limits") {
                    ...
                    if (!type || isNaN(value)) {
                        return message.reply({
                            content: null, flags: V2.flag,
                            components: [V2.container([V2.text("Usage: `!antinuke limit <channelDelete|roleDelete|ban|kick> <number>`")], V2_RED)]
                        });
                    }

                    const validTypes = ["channelDelete", "roleDelete", "ban", "kick"];
