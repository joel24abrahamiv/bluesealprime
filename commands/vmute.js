    ...
    async execute(message, args, commandName) {
        ...
        try {
            ...
            try {
                ...
                const muteFile = new AttachmentBuilder("./assets/vmute.png");
                const container = V2.container([
                    V2.section([
                        V2.heading("🎙️ SOVEREIGN_VOICE: MUTED", 2),
                        V2.text(`**Target:** ${target}\n**Channel:** ${target.voice.channel.name}\n**Status:** \`SECURE_MUTE_ACTIVE\``)
                    ], "attachment://vmute.png"),
                    V2.separator(),
                ...
                message.reply({ content: null, flags: V2.flag, files: [muteFile], components: [container] });
